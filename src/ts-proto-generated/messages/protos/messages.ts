...
//   protoc               v3.21.12
// source: messages/protos/messages.proto
...
export interface EditMapMessage {
  ...
  deleteFileMessage?: DeleteFileMessage | undefined;
}
...
export interface ClientToServerMessage {
  ...
  webRtcSignalToServerMessage?: WebRtcSignalToServerMessage | undefined;
  webRtcScreenSharingSignalToServerMessage?: WebRtcSignalToServerMessage | undefined;
  ...
  requestFullSyncMessage?: RequestFullSyncMessage | undefined;
}
...
export interface QueryMessage {
  ...
  turnCredentialsQuery?: TurnCredentialsQuery | undefined;
...
export interface AnswerMessage {
  ...
  turnCredentialsAnswer?: TurnCredentialsAnswer | undefined;
...
export interface SubMessage {
  ...
  editMapCommandMessage?: EditMapCommandMessage | undefined;
  joinMucRoomMessage?: JoinMucRoomMessage | undefined;
  leaveMucRoomMessage?: LeaveMucRoomMessage | undefined;
  addSpaceUserMessage?: AddSpaceUserPusherToFrontMessage | undefined;
...
export interface RequestFullSyncMessage {
  spaceName: string;
  users: SpaceUser[];
  senderUserId: string;
}
...
export interface ServerToClientMessage {
  ...
  webRtcSignalToClientMessage?: WebRtcSignalToClientMessage | undefined;
  webRtcScreenSharingSignalToClientMessage?: WebRtcSignalToClientMessage | undefined;
...
export const WebRtcSignalToServerMessage: MessageFns<WebRtcSignalToServerMessage> = {
  encode(message: WebRtcSignalToServerMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WebRtcSignalToServerMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const EditMapMessage: MessageFns<EditMapMessage> = {
  encode(message: EditMapMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.deleteFileMessage !== undefined) {
      DeleteFileMessage.encode(message.deleteFileMessage, writer.uint32(114).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14: {
          ...
          message.deleteFileMessage = DeleteFileMessage.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): EditMapMessage {
    return {
      ...
      uploadFileMessage: isSet(object.uploadFileMessage)
        ...
        : undefined,
      deleteFileMessage: isSet(object.deleteFileMessage)
        ? DeleteFileMessage.fromJSON(object.deleteFileMessage)
        : undefined,
    };
  },
  ...
  toJSON(message: EditMapMessage): unknown {
    ...
    if (message.deleteFileMessage !== undefined) {
      obj.deleteFileMessage = DeleteFileMessage.toJSON(message.deleteFileMessage);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<EditMapMessage>, I>>(object: I): EditMapMessage {
    ...
    message.uploadFileMessage = (object.uploadFileMessage !== undefined && object.uploadFileMessage !== null)
      ...
      : undefined;
    message.deleteFileMessage = (object.deleteFileMessage !== undefined && object.deleteFileMessage !== null)
      ? DeleteFileMessage.fromPartial(object.deleteFileMessage)
      : undefined;
    return message;
  },
};
...
function createBaseDeleteFileMessage(): DeleteFileMessage {
  return { propertyId: "", name: "" };
}

export const DeleteFileMessage: MessageFns<DeleteFileMessage> = {
  encode(message: DeleteFileMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteFileMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeleteFileMessage();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): DeleteFileMessage {
    return {
  ...
  toJSON(message: DeleteFileMessage): unknown {
    const obj: any = {};
    if (message.propertyId !== "") {
  ...
  create<I extends Exact<DeepPartial<DeleteFileMessage>, I>>(base?: I): DeleteFileMessage {
    return DeleteFileMessage.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DeleteFileMessage>, I>>(object: I): DeleteFileMessage {
    const message = createBaseDeleteFileMessage();
...
function createBaseClientToServerMessage(): ClientToServerMessage {
  return {
    ...
    webRtcSignalToServerMessage: undefined,
    webRtcScreenSharingSignalToServerMessage: undefined,
    ...
    requestFullSyncMessage: undefined,
  };
}
...
export const ClientToServerMessage: MessageFns<ClientToServerMessage> = {
  encode(message: ClientToServerMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.webRtcSignalToServerMessage !== undefined) {
      WebRtcSignalToServerMessage.encode(message.webRtcSignalToServerMessage, writer.uint32(58).fork()).join();
    }
    if (message.webRtcScreenSharingSignalToServerMessage !== undefined) {
      WebRtcSignalToServerMessage.encode(message.webRtcScreenSharingSignalToServerMessage, writer.uint32(66).fork())
        .join();
    }
    ...
    if (message.requestFullSyncMessage !== undefined) {
      RequestFullSyncMessage.encode(message.requestFullSyncMessage, writer.uint32(370).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.webRtcSignalToServerMessage = WebRtcSignalToServerMessage.decode(reader, reader.uint32());
          continue;
        }
        case 8: {
          if (tag !== 66) {
          ...
          message.webRtcScreenSharingSignalToServerMessage = WebRtcSignalToServerMessage.decode(
            reader,
            reader.uint32(),
          );
          continue;
        ...
        case 46: {
          ...
          message.requestFullSyncMessage = RequestFullSyncMessage.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ClientToServerMessage {
    return {
      ...
      setPlayerDetailsMessage: isSet(object.setPlayerDetailsMessage)
        ...
        : undefined,
      webRtcSignalToServerMessage: isSet(object.webRtcSignalToServerMessage)
        ? WebRtcSignalToServerMessage.fromJSON(object.webRtcSignalToServerMessage)
        : undefined,
      webRtcScreenSharingSignalToServerMessage: isSet(object.webRtcScreenSharingSignalToServerMessage)
        ? WebRtcSignalToServerMessage.fromJSON(object.webRtcScreenSharingSignalToServerMessage)
        : undefined,
      ...
      leaveChatRoomAreaMessage: isSet(object.leaveChatRoomAreaMessage)
        ...
        : undefined,
      requestFullSyncMessage: isSet(object.requestFullSyncMessage)
        ? RequestFullSyncMessage.fromJSON(object.requestFullSyncMessage)
        : undefined,
    };
  },
  ...
  toJSON(message: ClientToServerMessage): unknown {
    ...
    if (message.webRtcSignalToServerMessage !== undefined) {
      obj.webRtcSignalToServerMessage = WebRtcSignalToServerMessage.toJSON(message.webRtcSignalToServerMessage);
    }
    if (message.webRtcScreenSharingSignalToServerMessage !== undefined) {
      obj.webRtcScreenSharingSignalToServerMessage = WebRtcSignalToServerMessage.toJSON(
        message.webRtcScreenSharingSignalToServerMessage,
      );
    }
    if (message.playGlobalMessage !== undefined) {
    ...
    if (message.requestFullSyncMessage !== undefined) {
      obj.requestFullSyncMessage = RequestFullSyncMessage.toJSON(message.requestFullSyncMessage);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ClientToServerMessage>, I>>(object: I): ClientToServerMessage {
    ...
    message.webRtcSignalToServerMessage =
      (object.webRtcSignalToServerMessage !== undefined && object.webRtcSignalToServerMessage !== null)
        ? WebRtcSignalToServerMessage.fromPartial(object.webRtcSignalToServerMessage)
        : undefined;
    message.webRtcScreenSharingSignalToServerMessage =
      (object.webRtcScreenSharingSignalToServerMessage !== undefined &&
          object.webRtcScreenSharingSignalToServerMessage !== null)
        ? WebRtcSignalToServerMessage.fromPartial(object.webRtcScreenSharingSignalToServerMessage)
        : undefined;
    ...
    message.requestFullSyncMessage =
      (object.requestFullSyncMessage !== undefined && object.requestFullSyncMessage !== null)
        ? RequestFullSyncMessage.fromPartial(object.requestFullSyncMessage)
        : undefined;
    return message;
  },
};
...
function createBaseQueryMessage(): QueryMessage {
  return {
    ...
    turnCredentialsQuery: undefined,
...
export const QueryMessage: MessageFns<QueryMessage> = {
  encode(message: QueryMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.turnCredentialsQuery !== undefined) {
      TurnCredentialsQuery.encode(message.turnCredentialsQuery, writer.uint32(74).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.turnCredentialsQuery = TurnCredentialsQuery.decode(reader, reader.uint32());
          continue;
        }
        case 10: {
          if (tag !== 82) {
  ...
  fromJSON(object: any): QueryMessage {
    return {
      ...
      turnCredentialsQuery: isSet(object.turnCredentialsQuery)
        ? TurnCredentialsQuery.fromJSON(object.turnCredentialsQuery)
        : undefined,
  ...
  toJSON(message: QueryMessage): unknown {
    ...
    if (message.turnCredentialsQuery !== undefined) {
      obj.turnCredentialsQuery = TurnCredentialsQuery.toJSON(message.turnCredentialsQuery);
    }
    if (message.chatMembersQuery !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryMessage>, I>>(object: I): QueryMessage {
    ...
    message.getMemberQuery = (object.getMemberQuery !== undefined && object.getMemberQuery !== null)
      ...
      : undefined;
    message.turnCredentialsQuery = (object.turnCredentialsQuery !== undefined && object.turnCredentialsQuery !== null)
      ? TurnCredentialsQuery.fromPartial(object.turnCredentialsQuery)
      : undefined;
...
export const TurnCredentialsQuery: MessageFns<TurnCredentialsQuery> = {
  encode(_: TurnCredentialsQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TurnCredentialsQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const OauthRefreshTokenQuery: MessageFns<OauthRefreshTokenQuery> = {
  ...
  fromJSON(object: any): OauthRefreshTokenQuery {
    return { tokenToRefresh: isSet(object.tokenToRefresh) ? globalThis.String(object.tokenToRefresh) : "" };
  },
...
function createBaseAnswerMessage(): AnswerMessage {
  return {
    ...
    turnCredentialsAnswer: undefined,
...
export const AnswerMessage: MessageFns<AnswerMessage> = {
  encode(message: AnswerMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.turnCredentialsAnswer !== undefined) {
      TurnCredentialsAnswer.encode(message.turnCredentialsAnswer, writer.uint32(90).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11: {
          ...
          message.turnCredentialsAnswer = TurnCredentialsAnswer.decode(reader, reader.uint32());
          continue;
        }
        case 12: {
          if (tag !== 98) {
  ...
  fromJSON(object: any): AnswerMessage {
    return {
      ...
      turnCredentialsAnswer: isSet(object.turnCredentialsAnswer)
        ? TurnCredentialsAnswer.fromJSON(object.turnCredentialsAnswer)
        : undefined,
  ...
  toJSON(message: AnswerMessage): unknown {
    ...
    if (message.turnCredentialsAnswer !== undefined) {
      obj.turnCredentialsAnswer = TurnCredentialsAnswer.toJSON(message.turnCredentialsAnswer);
    }
    if (message.chatMembersAnswer !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<AnswerMessage>, I>>(object: I): AnswerMessage {
    ...
    message.turnCredentialsAnswer =
      (object.turnCredentialsAnswer !== undefined && object.turnCredentialsAnswer !== null)
        ? TurnCredentialsAnswer.fromPartial(object.turnCredentialsAnswer)
        : undefined;
...
export const JoinSpaceAnswer: MessageFns<JoinSpaceAnswer> = {
  encode(_: JoinSpaceAnswer, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  fromJSON(_: any): JoinSpaceAnswer {
    return {};
  },

  toJSON(_: JoinSpaceAnswer): unknown {
    const obj: any = {};
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<JoinSpaceAnswer>, I>>(_: I): JoinSpaceAnswer {
    const message = createBaseJoinSpaceAnswer();
    return message;
  },
};
...
export const TurnCredentialsAnswer: MessageFns<TurnCredentialsAnswer> = {
  encode(message: TurnCredentialsAnswer, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TurnCredentialsAnswer {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseSubMessage(): SubMessage {
  return {
    ...
    pingMessage: undefined,
    editMapCommandMessage: undefined,
    joinMucRoomMessage: undefined,
    leaveMucRoomMessage: undefined,
...
export const SubMessage: MessageFns<SubMessage> = {
  encode(message: SubMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.joinMucRoomMessage !== undefined) {
      JoinMucRoomMessage.encode(message.joinMucRoomMessage, writer.uint32(114).fork()).join();
    }
    if (message.leaveMucRoomMessage !== undefined) {
      LeaveMucRoomMessage.encode(message.leaveMucRoomMessage, writer.uint32(122).fork()).join();
    }
    if (message.addSpaceUserMessage !== undefined) {
      AddSpaceUserPusherToFrontMessage.encode(message.addSpaceUserMessage, writer.uint32(130).fork()).join();
    }
    if (message.updateSpaceUserMessage !== undefined) {
    ...
    if (message.privateEvent !== undefined) {
      PrivateEvent.encode(message.privateEvent, writer.uint32(242).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14: {
          ...
          message.joinMucRoomMessage = JoinMucRoomMessage.decode(reader, reader.uint32());
          continue;
        }
        case 15: {
          if (tag !== 122) {
          ...
          message.leaveMucRoomMessage = LeaveMucRoomMessage.decode(reader, reader.uint32());
          continue;
        }
        case 16: {
          if (tag !== 130) {
          ...
          message.addSpaceUserMessage = AddSpaceUserPusherToFrontMessage.decode(reader, reader.uint32());
          continue;
        }
        case 17: {
          if (tag !== 138) {
  ...
  fromJSON(object: any): SubMessage {
    return {
      ...
      editMapCommandMessage: isSet(object.editMapCommandMessage)
        ? EditMapCommandMessage.fromJSON(object.editMapCommandMessage)
        : undefined,
      joinMucRoomMessage: isSet(object.joinMucRoomMessage)
        ? JoinMucRoomMessage.fromJSON(object.joinMucRoomMessage)
        : undefined,
      leaveMucRoomMessage: isSet(object.leaveMucRoomMessage)
        ? LeaveMucRoomMessage.fromJSON(object.leaveMucRoomMessage)
        : undefined,
      addSpaceUserMessage: isSet(object.addSpaceUserMessage)
        ? AddSpaceUserPusherToFrontMessage.fromJSON(object.addSpaceUserMessage)
        : undefined,
      updateSpaceUserMessage: isSet(object.updateSpaceUserMessage)
  ...
  toJSON(message: SubMessage): unknown {
    ...
    if (message.joinMucRoomMessage !== undefined) {
      obj.joinMucRoomMessage = JoinMucRoomMessage.toJSON(message.joinMucRoomMessage);
    }
    if (message.leaveMucRoomMessage !== undefined) {
      obj.leaveMucRoomMessage = LeaveMucRoomMessage.toJSON(message.leaveMucRoomMessage);
    }
    if (message.addSpaceUserMessage !== undefined) {
      obj.addSpaceUserMessage = AddSpaceUserPusherToFrontMessage.toJSON(message.addSpaceUserMessage);
    }
    if (message.updateSpaceUserMessage !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<SubMessage>, I>>(object: I): SubMessage {
    ...
    message.editMapCommandMessage =
      (object.editMapCommandMessage !== undefined && object.editMapCommandMessage !== null)
        ? EditMapCommandMessage.fromPartial(object.editMapCommandMessage)
        : undefined;
    message.joinMucRoomMessage = (object.joinMucRoomMessage !== undefined && object.joinMucRoomMessage !== null)
      ? JoinMucRoomMessage.fromPartial(object.joinMucRoomMessage)
      : undefined;
    message.leaveMucRoomMessage = (object.leaveMucRoomMessage !== undefined && object.leaveMucRoomMessage !== null)
      ? LeaveMucRoomMessage.fromPartial(object.leaveMucRoomMessage)
      : undefined;
    message.addSpaceUserMessage = (object.addSpaceUserMessage !== undefined && object.addSpaceUserMessage !== null)
      ? AddSpaceUserPusherToFrontMessage.fromPartial(object.addSpaceUserMessage)
      : undefined;
    message.updateSpaceUserMessage =
      (object.updateSpaceUserMessage !== undefined && object.updateSpaceUserMessage !== null)
...
export const WebRtcSignalToClientMessage: MessageFns<WebRtcSignalToClientMessage> = {
  encode(message: WebRtcSignalToClientMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== 0) {
      writer.uint32(8).int32(message.userId);
    }
    if (message.signal !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WebRtcSignalToClientMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseRequestFullSyncMessage(): RequestFullSyncMessage {
  return { spaceName: "", users: [], senderUserId: "" };
}

export const RequestFullSyncMessage: MessageFns<RequestFullSyncMessage> = {
  encode(message: RequestFullSyncMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.spaceName !== "") {
      writer.uint32(10).string(message.spaceName);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RequestFullSyncMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRequestFullSyncMessage();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): RequestFullSyncMessage {
    return {
      spaceName: isSet(object.spaceName) ? globalThis.String(object.spaceName) : "",
  ...
  toJSON(message: RequestFullSyncMessage): unknown {
    const obj: any = {};
    if (message.spaceName !== "") {
      obj.spaceName = message.spaceName;
    }
  ...
  create<I extends Exact<DeepPartial<RequestFullSyncMessage>, I>>(base?: I): RequestFullSyncMessage {
    return RequestFullSyncMessage.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RequestFullSyncMessage>, I>>(object: I): RequestFullSyncMessage {
    const message = createBaseRequestFullSyncMessage();
    message.spaceName = object.spaceName ?? "";
...
export const PrivateSpaceEvent: MessageFns<PrivateSpaceEvent> = {
  encode(message: PrivateSpaceEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.addSpaceUserMessage !== undefined) {
      AddSpaceUserMessage.encode(message.addSpaceUserMessage, writer.uint32(34).fork()).join();
    }
    if (message.updateSpaceUserMessage !== undefined) {
      UpdateSpaceUserMessage.encode(message.updateSpaceUserMessage, writer.uint32(42).fork()).join();
    }
    if (message.removeSpaceUserMessage !== undefined) {
      RemoveSpaceUserMessage.encode(message.removeSpaceUserMessage, writer.uint32(50).fork()).join();
    }
    return writer;
  },
...
function createBaseServerToClientMessage(): ServerToClientMessage {
  return {
    ...
    webRtcSignalToClientMessage: undefined,
    webRtcScreenSharingSignalToClientMessage: undefined,
...
export const ServerToClientMessage: MessageFns<ServerToClientMessage> = {
  encode(message: ServerToClientMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.webRtcSignalToClientMessage !== undefined) {
      WebRtcSignalToClientMessage.encode(message.webRtcSignalToClientMessage, writer.uint32(42).fork()).join();
    }
    if (message.webRtcScreenSharingSignalToClientMessage !== undefined) {
      WebRtcSignalToClientMessage.encode(message.webRtcScreenSharingSignalToClientMessage, writer.uint32(50).fork())
        .join();
    }
    if (message.webRtcDisconnectMessage !== undefined) {
      WebRtcDisconnectMessage.encode(message.webRtcDisconnectMessage, writer.uint32(58).fork()).join();
    }
    ...
    if (message.groupUsersUpdateMessage !== undefined) {
      GroupUsersUpdateMessage.encode(message.groupUsersUpdateMessage, writer.uint32(202).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.webRtcSignalToClientMessage = WebRtcSignalToClientMessage.decode(reader, reader.uint32());
          continue;
        }
        case 6: {
          if (tag !== 50) {
          ...
          message.webRtcScreenSharingSignalToClientMessage = WebRtcSignalToClientMessage.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): ServerToClientMessage {
    return {
      ...
      webRtcStartMessage: isSet(object.webRtcStartMessage)
        ...
        : undefined,
      webRtcSignalToClientMessage: isSet(object.webRtcSignalToClientMessage)
        ? WebRtcSignalToClientMessage.fromJSON(object.webRtcSignalToClientMessage)
        : undefined,
      webRtcScreenSharingSignalToClientMessage: isSet(object.webRtcScreenSharingSignalToClientMessage)
        ? WebRtcSignalToClientMessage.fromJSON(object.webRtcScreenSharingSignalToClientMessage)
        : undefined,
  ...
  toJSON(message: ServerToClientMessage): unknown {
    ...
    if (message.webRtcSignalToClientMessage !== undefined) {
      obj.webRtcSignalToClientMessage = WebRtcSignalToClientMessage.toJSON(message.webRtcSignalToClientMessage);
    }
    if (message.webRtcScreenSharingSignalToClientMessage !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<ServerToClientMessage>, I>>(object: I): ServerToClientMessage {
    ...
    message.webRtcSignalToClientMessage =
      (object.webRtcSignalToClientMessage !== undefined && object.webRtcSignalToClientMessage !== null)
        ? WebRtcSignalToClientMessage.fromPartial(object.webRtcSignalToClientMessage)
        : undefined;
    message.webRtcScreenSharingSignalToClientMessage =
      (object.webRtcScreenSharingSignalToClientMessage !== undefined &&
          object.webRtcScreenSharingSignalToClientMessage !== null)
        ? WebRtcSignalToClientMessage.fromPartial(object.webRtcScreenSharingSignalToClientMessage)
        : undefined;
...
export const PusherToBackMessage: MessageFns<PusherToBackMessage> = {
  encode(message: PusherToBackMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.webRtcSignalToServerMessage !== undefined) {
      WebRtcSignalToServerMessage.encode(message.webRtcSignalToServerMessage, writer.uint32(50).fork()).join();
    }
    if (message.webRtcScreenSharingSignalToServerMessage !== undefined) {
      WebRtcSignalToServerMessage.encode(message.webRtcScreenSharingSignalToServerMessage, writer.uint32(58).fork())
        .join();
    }
    if (message.sendUserMessage !== undefined) {
      SendUserMessage.encode(message.sendUserMessage, writer.uint32(98).fork()).join();
...
export const BatchToPusherMessage: MessageFns<BatchToPusherMessage> = {
  encode(message: BatchToPusherMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.payload) {
      SubToPusherMessage.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): BatchToPusherMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SubToPusherMessage: MessageFns<SubToPusherMessage> = {
  encode(message: SubToPusherMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userJoinedZoneMessage !== undefined) {
      UserJoinedZoneMessage.encode(message.userJoinedZoneMessage, writer.uint32(10).fork()).join();
    }
    if (message.groupUpdateZoneMessage !== undefined) {
      GroupUpdateZoneMessage.encode(message.groupUpdateZoneMessage, writer.uint32(18).fork()).join();
    }
    if (message.userMovedMessage !== undefined) {
      UserMovedMessage.encode(message.userMovedMessage, writer.uint32(26).fork()).join();
    }
    if (message.groupLeftZoneMessage !== undefined) {
      GroupLeftZoneMessage.encode(message.groupLeftZoneMessage, writer.uint32(34).fork()).join();
    }
    if (message.userLeftZoneMessage !== undefined) {
      UserLeftZoneMessage.encode(message.userLeftZoneMessage, writer.uint32(42).fork()).join();
    }
    if (message.itemEventMessage !== undefined) {
      ItemEventMessage.encode(message.itemEventMessage, writer.uint32(50).fork()).join();
    }
    if (message.sendUserMessage !== undefined) {
      SendUserMessage.encode(message.sendUserMessage, writer.uint32(58).fork()).join();
    }
    if (message.banUserMessage !== undefined) {
      BanUserMessage.encode(message.banUserMessage, writer.uint32(66).fork()).join();
    }
    if (message.emoteEventMessage !== undefined) {
      EmoteEventMessage.encode(message.emoteEventMessage, writer.uint32(74).fork()).join();
    }
    if (message.errorMessage !== undefined) {
      ErrorMessage.encode(message.errorMessage, writer.uint32(82).fork()).join();
    }
    if (message.playerDetailsUpdatedMessage !== undefined) {
      PlayerDetailsUpdatedMessage.encode(message.playerDetailsUpdatedMessage, writer.uint32(90).fork()).join();
    }
    if (message.editMapCommandMessage !== undefined) {
      EditMapCommandMessage.encode(message.editMapCommandMessage, writer.uint32(98).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SubToPusherMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SubToPusherRoomMessage: MessageFns<SubToPusherRoomMessage> = {
  encode(message: SubToPusherRoomMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.joinMucRoomMessage !== undefined) {
      JoinMucRoomMessage.encode(message.joinMucRoomMessage, writer.uint32(34).fork()).join();
    }
    if (message.leaveMucRoomMessage !== undefined) {
      LeaveMucRoomMessage.encode(message.leaveMucRoomMessage, writer.uint32(42).fork()).join();
    }
    if (message.receivedEventMessage !== undefined) {
...
function createBaseChatMessagePrompt(): ChatMessagePrompt {
  return { roomId: "", joinMucRoomMessage: undefined, leaveMucRoomMessage: undefined };
}

export const ChatMessagePrompt: MessageFns<ChatMessagePrompt> = {
  encode(message: ChatMessagePrompt, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.roomId !== "") {
      writer.uint32(10).string(message.roomId);
    }
    if (message.joinMucRoomMessage !== undefined) {
      JoinMucRoomMessage.encode(message.joinMucRoomMessage, writer.uint32(18).fork()).join();
    }
    if (message.leaveMucRoomMessage !== undefined) {
      LeaveMucRoomMessage.encode(message.leaveMucRoomMessage, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ChatMessagePrompt {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const JoinMucRoomMessage: MessageFns<JoinMucRoomMessage> = {
  encode(message: JoinMucRoomMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.mucRoomDefinitionMessage !== undefined) {
      MucRoomDefinitionMessage.encode(message.mucRoomDefinitionMessage, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): JoinMucRoomMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const LeaveMucRoomMessage: MessageFns<LeaveMucRoomMessage> = {
  encode(message: LeaveMucRoomMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.url !== "") {
      writer.uint32(10).string(message.url);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LeaveMucRoomMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MucRoomDefinitionMessage: MessageFns<MucRoomDefinitionMessage> = {
  encode(message: MucRoomDefinitionMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.url !== "") {
      writer.uint32(10).string(message.url);
    }
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MucRoomDefinitionMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const BanUserByUuidMessage: MessageFns<BanUserByUuidMessage> = {
  encode(message: BanUserByUuidMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.playUri !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BanUserByUuidMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const PusherToBackSpaceMessage: MessageFns<PusherToBackSpaceMessage> = {
  encode(message: PusherToBackSpaceMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.requestFullSyncMessage !== undefined) {
      RequestFullSyncMessage.encode(message.requestFullSyncMessage, writer.uint32(154).fork()).join();
    }
    return writer;
  },
...
export const BackToPusherSpaceMessage: MessageFns<BackToPusherSpaceMessage> = {
  encode(message: BackToPusherSpaceMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.privateEvent !== undefined) {
      PrivateEvent.encode(message.privateEvent, writer.uint32(114).fork()).join();
    }
...
function createBaseJoinSpaceMessage(): JoinSpaceMessage {
  return { spaceName: "", filterType: 0, isRetry: false };
}
...
export const JoinSpaceMessage: MessageFns<JoinSpaceMessage> = {
  encode(message: JoinSpaceMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.isRetry !== false) {
      writer.uint32(24).bool(message.isRetry);
    }
    return writer;
  },
  ...
  fromJSON(object: any): JoinSpaceMessage {
    return {
      spaceName: isSet(object.spaceName) ? globalThis.String(object.spaceName) : "",
      filterType: isSet(object.filterType) ? filterTypeFromJSON(object.filterType) : 0,
      isRetry: isSet(object.isRetry) ? globalThis.Boolean(object.isRetry) : false,
    };
  },
...
export const AddSpaceUserPusherToFrontMessage: MessageFns<AddSpaceUserPusherToFrontMessage> = {
  encode(message: AddSpaceUserPusherToFrontMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.spaceName !== "") {
      writer.uint32(10).string(message.spaceName);
    }
    if (message.user !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddSpaceUserPusherToFrontMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
