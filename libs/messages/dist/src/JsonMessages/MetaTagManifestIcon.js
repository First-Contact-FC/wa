...
exports.isMetaTagManifestIcon = (0, zod_openapi_1.extendApi)(zod_1.z.object({
    ...
    type: (0, zod_openapi_1.extendApi)(zod_1.z.string().optional(), {
    ...
    purpose: (0, zod_openapi_1.extendApi)(zod_1.z.string().optional(), {
