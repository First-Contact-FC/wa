...
const isBbbData = zod_1.z.object({
    ...
    secret: (0, zod_openapi_1.extendApi)(zod_1.z.string(), {
...
const isJitsiData = zod_1.z.object({
    ...
    iss: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The Jitsi ISS setting. See https://github.com/jitsi/lib-jitsi-meet/blob/master/doc/tokens.md",
        default: false,
    }),
    secret: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
...
const isMapThirdPartyData = zod_1.z.object({
    bbb: (0, zod_openapi_1.extendApi)(isBbbData.nullable().optional(), {
        description: "Use these settings to override default BigBlueButton settings.",
    }),
    jitsi: (0, zod_openapi_1.extendApi)(isJitsiData.nullable().optional(), {
        description: "Use these settings to override default Jitsi settings.",
    }),
});
const MetaTagsData = zod_1.z.object({
    // Meta tags values
    title: (0, zod_openapi_1.extendApi)(zod_1.z.string().optional().default("WorkAdventure"), {
        description: "Title shown on browser tab",
        example: "WorkAdventure - My Awesome World",
    }),
    description: (0, zod_openapi_1.extendApi)(zod_1.z.string().optional().default("Create your own digital office, Metaverse and meet online with the world."), {
        description: "Description of the webpage",
        example: "My awesome world in WorkAdventure",
    }),
    author: (0, zod_openapi_1.extendApi)(zod_1.z.string().optional().default("WorkAdventure team"), {
        description: "Author of the webpage",
        example: "My Awesome team",
    }),
    provider: (0, zod_openapi_1.extendApi)(zod_1.z.string().optional().default("WorkAdventure"), {
        description: "Provider of the webpage",
        example: "WorkAdventure SAAS platform",
    }),
    favIcons: (0, zod_openapi_1.extendApi)(MetaTagFavicon_1.isMetaTagFavicon.array().optional(), {
    ...
    appName: (0, zod_openapi_1.extendApi)(zod_1.z.string().optional(), {
        description: "Name display on the PWA",
        example: "WorkAdventure",
    }),
    shortAppName: (0, zod_openapi_1.extendApi)(zod_1.z.string().optional(), {
        description: "PWA name when there not enough space",
        example: "WA",
    }),
    themeColor: (0, zod_openapi_1.extendApi)(zod_1.z.string().optional(), {
        description: "Color use for theme PWA icons, Windows app and android browser",
        example: "#000000",
    }),
    cardImage: (0, zod_openapi_1.extendApi)(zod_1.z.string().optional(), {
...
const isLegalsData = zod_1.z.object({
    termsOfUseUrl: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The link to the 'terms of user' page (link displayed on the 'enter your name' scene)",
    }),
    privacyPolicyUrl: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The link to the 'privacy policy' page (link displayed on the 'enter your name' scene)",
    }),
    cookiePolicyUrl: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
...
const CustomizeSceneData = zod_1.z.object({
    clothesIcon: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The URL of the clothes icon",
    }),
    accessoryIcon: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The URL of the accessory icon",
    }),
    hatIcon: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The URL of the hat icon",
    }),
    hairIcon: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The URL of the hair icon",
    }),
    eyesIcon: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The URL of the eyes icon",
    }),
    bodyIcon: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The URL of the body icon",
    }),
    turnIcon: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The URL of the turn icon",
    }),
});
exports.isMapDetailsData = zod_1.z.object({
    mapUrl: (0, zod_openapi_1.extendApi)(zod_1.z.string().optional(), {
        description: "The full URL to the JSON map file",
        example: "https://myuser.github.io/myrepo/map.json",
    }),
    wamUrl: (0, zod_openapi_1.extendApi)(zod_1.z.string().url().optional(), {
        description: "The full URL to the WAM map file",
        example: "https://map-storage.myworkadventure.com/myrepo/map.wam",
    }),
    authenticationMandatory: (0, zod_openapi_1.extendApi)(zod_1.z.boolean().nullable().optional(), {
        description: "Whether the authentication is mandatory or not for this map",
        example: true,
    }),
    group: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable(), {
        description: 'The group this room is part of (maps the notion of "world" in WorkAdventure SAAS)',
        example: "myorg/myworld",
    }),
    contactPage: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The URL to the contact page",
        example: "https://mycompany.com/contact-us",
    }),
    opidLogoutRedirectUrl: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The URL of the logout redirect",
        example: "https://mycompany.com/logout",
    }),
    opidWokaNamePolicy: (0, zod_openapi_1.extendApi)(OpidWokaNamePolicy_1.OpidWokaNamePolicy.nullable().optional(), {
        description: "Username policy",
        example: "user_input",
    }),
    // The date (in ISO 8601 format) at which the room will expire
    expireOn: (0, zod_openapi_1.extendApi)(zod_1.z.optional(zod_1.z.string()), {
    ...
    canReport: (0, zod_openapi_1.extendApi)(zod_1.z.boolean().optional(), {
        description: 'Whether the "report" feature is enabled or not on this room',
        example: true,
    }),
    editable: (0, zod_openapi_1.extendApi)(zod_1.z.optional(zod_1.z.boolean()), {
    ...
    loadingLogo: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The URL of the image to be used on the loading page",
        example: "https://example.com/logo.png",
    }),
    // The URL of the logo image on "LoginScene"
    loginSceneLogo: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The URL of the image to be used on the LoginScene",
        example: "https://example.com/logo_login.png",
    }),
    backgroundSceneImage: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The URL of the background image to be used on the loading page",
        example: "https://example.com/background.png",
    }),
    showPoweredBy: (0, zod_openapi_1.extendApi)(zod_1.z.boolean().nullable().optional(), {
        description: "Whether the logo PoweredBy is enabled or not on this room",
        example: true,
    }),
    thirdParty: (0, zod_openapi_1.extendApi)(isMapThirdPartyData.nullable().optional(), {
        description: "Configuration data for third party services",
    }),
    metadata: (0, zod_openapi_1.extendApi)(zod_1.z.unknown().optional(), {
        description: "Metadata from administration",
    }),
    roomName: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The name of the current room.",
        example: "WA Village",
    }),
    pricingUrl: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
    ...
    entityCollectionsUrls: (0, zod_openapi_1.extendApi)(zod_1.z.array(zod_1.z.string()).optional().nullable(), {
        description: "What entity collections are available for this map",
    }),
    // The URL of the error image on "ErrorScene"
    errorSceneLogo: (0, zod_openapi_1.extendApi)(zod_1.z.string().nullable().optional(), {
        description: "The URL of the error image to be used on the ErrorScene",
        example: "https://example.com/error_logo_login.png",
    }),
    modules: (0, zod_openapi_1.extendApi)(zod_1.z.array(zod_1.z.string()).optional().nullable(), {
        description: "List of external-modules to load",
    }),
    isLogged: (0, zod_openapi_1.extendApi)(zod_1.z.boolean().optional(), {
